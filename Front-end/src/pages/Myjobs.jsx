...
const itemsPerPage = 4;
    useEffect(()=>{
               setIsLoading(true);
               fetch(`https://vervebridge-online-job-portal.onrender.com/myJobs/garigantimanohar29@gmail.com`).then(res => res.json()).then(data => {setJobs(data)
                setIsLoading(false);
               })
    },[searchText]);
    // pagination
    ...
    const handleDelete = (id) =>{
        fetch(`https://vervebridge-online-job-portal.onrender.com/job/${id}`,{
            method:"DELETE",
